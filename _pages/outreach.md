...
<div style="border: 2px solid #2196F3; padding: 10px; border-radius: 10px; margin-bottom: 20px;">
  ...
  <div style="display: flex; flex-wrap: wrap;">
    ...
    <img src="/images/nasa_starbites.jpg" alt="" style="width: 48%; margin: 1%;" />
    <img src="/images/StarBites_Team.png" alt="" style="width: 48%; margin: 1%;" />
  </div>
</div>
