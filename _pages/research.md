...
<style>
  :root {
    ...
    --border-color-green-dark: #81C784;
    --border-color-blue-light: #2196F3;
    --border-color-blue-dark: #64B5F6;
    --border-color-orange-light: #FF9800;
    --border-color-orange-dark: #FFB74D;
    --border-color-red-light: #FF5722;
  ...
  /* Border color changes for different sections */
  .content-container.green {
    border-color: var(--border-color-green-light);
  }
  .content-container.blue {
    border-color: var(--border-color-blue-light);
  }
  .content-container.orange {
    border-color: var(--border-color-orange-light);
  }
  .content-container.red {
    border-color: var(--border-color-red-light);
  }
  ...
  @media (prefers-color-scheme: dark) {
    ...
    .content-container.blue {
      border-color: var(--border-color-blue-dark);
    }
    .content-container.orange {
      border-color: var(--border-color-orange-dark);
    }
    .content-container.red {
      border-color: var(--border-color-red-dark);
    }
  }
</style>
