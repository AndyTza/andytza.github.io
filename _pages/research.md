...
<div style="border: 4px solid #FF5722; padding: 20px; border-radius: 15px; margin-bottom: 30px; background: #fbe9e7;">
  ...
  <p>During my undergraduate studies, I was extensively interested in probing the 3D distribution of stars in the Milky Way's disk under the mentorship of [Professor Allyson Sheffield](google.com), [Professor Kathryn Johnston](http://user.astro.columbia.edu/~kvj/), and [Dr. Chervin Laporte](https://icc.ub.edu/people/647). I was very fortunate to be part of a few studies that uncovered observational and simulated N-body models that the Galactic disk is oscillating and kicking out stars from the disk into the Galactic halo, due to past dwarf satellite galaxy interactions with the Milky Way ([Laporte et al. 2018](https://arxiv.org/pdf/1803.11198),[Sheffield et al. 2018](https://arxiv.org/pdf/1801.01171)).</p>
