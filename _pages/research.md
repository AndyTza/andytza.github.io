...
<div style="border: 4px solid #E6A8D7; padding: 20px; border-radius: 15px; margin-bottom: 30px; background: #f0fff4;">
  ...
  <img src="/images/msdip.jpeg" alt="Sky position of main-sequence dipper stars and example of ZTF light curve." style="width:80%; border-radius: 10px;" />
  <img src="/images/mslc1.png" alt="Disk Eclipse Comparison" style="width: 80%; border-radius: 10px;" />
  </div>
